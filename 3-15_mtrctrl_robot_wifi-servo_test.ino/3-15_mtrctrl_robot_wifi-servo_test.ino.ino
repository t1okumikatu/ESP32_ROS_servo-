...
void servoL_cb(const std_msgs::UInt16& cmd_msg){
...
void servoR_cb(const std_msgs::UInt16& cmd_msg){
...
ros::Subscriber<std_msgs::UInt16> subL("servo_L", servoL_cb);
ros::Subscriber<std_msgs::UInt16> subR("servo_R", servoR_cb);
